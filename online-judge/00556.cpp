...
struct Bot {
    ...
    bool did_return() {
        return i == target_i and j == target_j;
    }
...
int main() {
    while (true) {
        ...
        // we also override all "1"s to "-1"s cuz we gonna use the same field variable for counting the visits
        vvi field;
        field.resize(n + 2);
        ...
        do {
            ...
            if (move_type == 1) goto move_without_check;
        ...
        printf("% 3d% 3d% 3d% 3d% 3d\n", zero_count, one_count, two_count, three_count, four_count);
    }
}
