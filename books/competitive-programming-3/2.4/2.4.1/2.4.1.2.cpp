...
vector<vi> edge_list_2_adj_matrix(vector<pair<int, ii>>& edge_list, int v, int e) {
...
vector<vii> edge_list_2_adj_list(vector<pair<int, ii>>& edge_list, int v, int e) {
    vector<vii> adj_list;
    adj_list.resize(v);
...
vector<pair<int, ii>> adj_matrix_2_edge_list(vector<vi>& adj_matrix, int v, int e) {
...
vector<pair<int, ii>> adj_list_2_edge_list(vector<vii>& adj_list, int v, int e) {
    vector<pair<int, ii>> edge_list;
