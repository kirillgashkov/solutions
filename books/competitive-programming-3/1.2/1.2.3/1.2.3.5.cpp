...
int main(int argc, char const* argv[]) {
  ...
  sort(sorted_by_month.begin(), sorted_by_month.end(),
       [](tuple<int, int, int>* d1, tuple<int, int, int>* d2) {
         return get<1>(*d1) < get<1>(*d2);
       });

  vector<tuple<int, int, int>*> sorted_by_day = pointers;
  sort(sorted_by_day.begin(), sorted_by_day.end(),
       [](tuple<int, int, int>* d1, tuple<int, int, int>* d2) {
  ...
  sort(
      sorted_by_age.begin(), sorted_by_age.end(),
      [](tuple<int, int, int>* d1, tuple<int, int, int>* d2) {
